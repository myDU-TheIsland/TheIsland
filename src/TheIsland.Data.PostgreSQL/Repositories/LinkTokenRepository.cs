...
namespace TheIsland.Data.PostgreSQL.Repositories
{
    ...
    public class LinkTokenRepository : NpgsqlEntityRepository<LinkToken>, ILinkTokenRepository
    {
        public LinkTokenRepository(IDatabaseSettings settings) : base(settings, settings.Database)
        {
        }
