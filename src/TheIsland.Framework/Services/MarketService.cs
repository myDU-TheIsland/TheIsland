...
namespace TheIsland.Framework.Services
{
    ...
    using static TheIsland.Framework.Helpers.RandomHelpers;

    public class MarketService : IAppService
    {
        private readonly IDualMarketTransactionRepository _dualMarketTransactionRepository;
        ...
        public MarketService(
            ...
            IDualMarketTransactionRepository dualMarketTransactionRepository,
        ...
        public async Task<List<string>> SellMarketContainerContents(double marketId)
        {
            ...
            try
            {
                ...
                logMessage($@"Fetching Container Contents for market {marketId} with these items {JsonSerializer.Serialize(this._marketBot.ResellItems)}!");
                ...
                logMessage($@"Container contents {JsonSerializer.Serialize(containerContents.slots)}!");
