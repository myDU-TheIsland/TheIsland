...
namespace TheIsland.Framework.Bots
{
    ...
    public class MarketBot : BotClient, IMarketBot
    {
        ...
        private readonly IMarketBuyLimitRepository _marketBuyLimitRepository;
        ...
        public MarketBot(
            ...
            IMarketBuyLimitRepository marketBuyLimitRepository,
        ...
        {
            IEnumerable<IGameplayDefinition> allItems = this.Bot.GameplayBank.GetDefinitions();
